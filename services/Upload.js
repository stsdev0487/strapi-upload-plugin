...
module.exports = {
  ...
  async enhanceFile(file, fileInfo = {}, metas = {}) {
    console.debug('enhanceFile');
    let readBuffer;
    try {
      readBuffer = await util.promisify(fs.readFile)(file.path);
    } catch (e) {
      console.debug('enhanceFile error ', e);
  ...
  async uploadFileAndPersist(fileData, { user } = {}) {
    console.debug('uploadFileAndPersist ');
    const config = strapi.plugins.upload.config;
    console.debug('uploadFileAndPersist config ', config);
    console.debug('uploadFileAndPersist fileData ', fileData);
    ...
    console.debug('upload before');
    await strapi.plugins.upload.provider.upload(fileData);
    console.debug('upload after');
